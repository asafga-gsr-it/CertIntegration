...
namespace SQLite
{
    public class SqlLite
    {
        ...
        public void createNewDatabase()
        {
            ...
            if (File.Exists("c:\\Users\\Administrator\\Desktop\\ca\\App_Data\\MyDatabase.sqlite"))
            {
                return;
            }
            else
            {
                SQLiteConnection.CreateFile("c:\\Users\\Administrator\\Desktop\\ca\\App_Data\\MyDatabase.sqlite");
                connectToDatabase();
                createTable();
                createTableHost();
        ...
        {
          //  var connStr = @"C:'//'MyDatabase.sqlite";
              m_dbConnection = new SQLiteConnection("Data Source=c:\\Users\\Administrator\\Desktop\\ca\\App_Data\\MyDatabase.sqlite;Version=3");
      
          //  m_dbConnection = new SQLiteConnection(connStr);
        ...
        public int  updateCertInfo(string Cert, int reqid)
        {
            ...
            objFile = File.CreateText("c:\\Users\\Administrator\\Desktop\\ca\\App_Data\\" + reqid + ".cer");
            objFile.Write(Cert);
            objFile.Close();
            X509Certificate2 cert = new X509Certificate2("c:\\Users\\Administrator\\Desktop\\ca\\App_Data\\"+reqid + ".cer");
            ...
            File.Delete("c:\\Users\\Administrator\\Desktop\\ca\\App_Data\\" + reqid + ".cer"); 
            connectToDatabase();
